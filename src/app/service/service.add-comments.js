System.register(["@angular/core", "rxjs/BehaviorSubject", "./service.search"], function (exports_1, context_1) {
    ...
    var core_1, BehaviorSubject_1, service_search_1, ServiceAddComments;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            ServiceAddComments = (function () {
                function ServiceAddComments(serviceSearch) {
                ...
                ServiceAddComments.prototype.addComments = function (photos) {
                    var _this = this;
                    var photosLen = photos.length;
                    var _loop_1 = function (item) {
                        this_1.serviceSearch.getComments(item.id).subscribe(function (response) {
                            if (response) {
                ...
                return ServiceAddComments;
            }());
            ServiceAddComments = __decorate([
                core_1.Injectable(),
                __metadata("design:paramtypes", [service_search_1.ServiceSearch])
            ], ServiceAddComments);
            exports_1("ServiceAddComments", ServiceAddComments);
        }
    };
});
//# sourceMappingURL=service.add-comments.js.map